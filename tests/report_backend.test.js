...
test("resolvePromptPathname switches gist requests to the gist prompt", () => {
  assert.match(reportBackend.resolvePromptPathname("/v1/report"), /generate_report\.md$/);
  assert.match(reportBackend.resolvePromptPathname("/v1/gist"), /generate_gist\.md$/);
});
